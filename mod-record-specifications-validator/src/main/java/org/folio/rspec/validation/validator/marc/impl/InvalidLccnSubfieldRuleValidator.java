...
public class InvalidLccnSubfieldRuleValidator
  ...
  private static final Pattern LCCN_STRUCTURE_A_PATTERN = Pattern.compile("(|[a-z]){3}\\d{8}");
  private static final Pattern LCCN_STRUCTURE_B_PATTERN = Pattern.compile("(|[a-z]){2}\\d{10}");
