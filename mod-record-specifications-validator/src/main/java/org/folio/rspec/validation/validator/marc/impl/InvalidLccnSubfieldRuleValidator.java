...
public class InvalidLccnSubfieldRuleValidator
  ...
  private static final Pattern LCCN_STRUCTURE_A_PATTERN = Pattern.compile("[|a-z]?[|a-z]?[|a-z]?\\d{8}");
  private static final Pattern LCCN_STRUCTURE_B_PATTERN = Pattern.compile("[|a-z]?[|a-z]?\\d{10}");
