...
class Marc4jConverterTest {
  ...
  void testConvert_WhenCalled_ShouldReturnMarcRecord() {
    ...
    assertThat(marcRecord.getControlFields())
      ...
      .containsExactlyInAnyOrder(expectedControlFields());
    ...
    assertThat(marcRecord.getDataFields())
      ...
      .containsExactlyInAnyOrder(expectedDataFields());
  }

  private Tuple[] expectedControlFields() {
    return new Tuple[] {Assertions.tuple("000[0]", "01750ccm a2200421   4500"),
                        Assertions.tuple("001[0]", "393893"),
                        Assertions.tuple("005[0]", "20141107001016.0"),
                        Assertions.tuple("006[0]", "c bcdefghijklmn o "),
                        Assertions.tuple("007[0]", "sa bcdefghijkl"),
                        Assertions.tuple("008[0]", "abcdefghijklmnopqr bcdefghijklmn o stuvw")};
  }

  private Tuple[] expectedDataFields() {
    return new Tuple[] {Assertions.tuple("035[0]", "035[0]^1=#;035[0]^2=#", "035[0]$a[0]=(OCoLC)63611770"),
                        Assertions.tuple("650[0]", "650[0]^1=#;650[0]^2=0",
                          "650[0]$a[0]=Instrumental music"),
                        Assertions.tuple("650[1]", "650[1]^1=#;650[1]^2=7",
                          "650[1]$0[0]=(OCoLC)fst00974414 650[1]$a[0]=Instrumental music 650[1]$2[0]=fast"),
                        Assertions.tuple("650[2]", "650[2]^1=#;650[2]^2=7",
                          "650[2]$0[0]=(OCoLC)fst01168379 650[2]$a[0]=Vocal music 650[2]$2[0]=fast"),
                        Assertions.tuple("100[0]", "100[0]^1=0;100[0]^2=#",
                          "100[0]$0[0]=12345 100[0]$a[0]=Mozart, Wolfgang Amadeus, "
                          + "100[0]$d[0]=1756-1791. 100[0]$9[0]=b9a5f035-de63-4e2c-92c2-07240c88b817"),
                        Assertions.tuple("035[1]", "035[1]^1=#;035[1]^2=#", "035[1]$a[0]=393893"),
                        Assertions.tuple("245[0]", "245[0]^1=1;245[0]^2=0",
                        ...
                        Assertions.tuple("047[0]", "047[0]^1=#;047[0]^2=#",
                        ...
                        Assertions.tuple("010[0]", "010[0]^1=#;010[0]^2=#",
                          "010[0]$a[0]=  2001000234 010[0]$z[0]=0001 010[0]$z[1]=0002")};
  }
